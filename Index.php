...
<div class="carousel ">
    <div class="list">
      <div class="item">
        ...
        <div class="content">
        <div class="author">پکا فود</div>
          <div class="title"> </div>
          <div class="topic">لورم ایپسوم</div>
          <div class="des">لورم ایپسوم متن ساختگی </div>
          <div class="buttons">
        <a href="menu.php" class="btn"> <i class='bx bxs-right-arrow'></i>منو</a>
        <a href="book.php" class="btn2">همین الان رزرو کنید</a>
        </div>
        </div>
      </div>
      <div class="item">
      ...
      <li class="promo-item">
        <div class="promo-card">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="none" xmlns:v="https://vecta.io/nano">
                  ...
                  <h3 class="h3 card-title">پیتزا </h3>
                  <p class="card-text">
                  لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است
                  </p>
                  <img src="img/promo-1.png" alt="" class="w-100 card-banner" width="230" height="230" loading="lazy">
      ...
      <li class="promo-item">
        <div class="promo-card">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="none" xmlns:v="https://vecta.io/nano">
                  ...
                  <h3 class="h3 card-title">نوشیدنی </h3>
                  <p class="card-text">
                  لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است
                  </p>
                  <img src="img/promo-2.png" alt="" class="w-100 card-banner" width="230" height="230" loading="lazy">
      ...
      <li class="promo-item">
        <div class="promo-card">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="none" xmlns:v="https://vecta.io/nano">
                  ...
                  <h3 class="h3 card-title">پیش غذا </h3>
                  <p class="card-text">
                  لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است
                  </p>
                  <img src="img/promo-3.png" alt="" class="w-100 card-banner" width="230" height="230" loading="lazy">
      ...
      <li class="promo-item">
        <div class="promo-card">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="none" xmlns:v="https://vecta.io/nano">
                  ...
                  <h3 class="h3 card-title">برگر </h3>
                  <p class="card-text">
                  لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است
                  </p>
                  <img src="img/promo-4.png" alt="" class="w-100 card-banner" width="230" height="230" loading="lazy">
      ...
      <li class="promo-item">
        <div class="promo-card">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="none" xmlns:v="https://vecta.io/nano">
                  ...
                  <h3 class="h3 card-title">چیکن ماسالا </h3>
                  <p class="card-text">
                  لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است
                  </p>
                  <img src="img/promo-5.png" alt="" class="w-100 card-banner" width="230" height="230" loading="lazy">
...
<li data-filter=".salad"><lord-icon
  ...
  <div class="box-tab breakfest">
    <div class="roww">
      <img src="img/menu/breakfest/b1.png"/>
      <h3>بشقاب سبزیجات </h3>
      <p> سبزیجات ساته-تخم مرغ آب پز-موزارلا تازه-روغن زیتون.</p>
    <div class="in-text">
      <div class="price">
        <h6>210,000 تومان  </h6>
      </div>
  ...
  <div class="box-tab breakfest">
    <div class="roww">
      <img src="img/menu/breakfest/b2.png"/>
      <h3> بشقاب آمریکایی</h3>
  ...
  <div class="box-tab salad">
    <div class="roww">
      <img src="img/menu/salad/salad1.png"/>
      <h3>چیز سیب زمینی</h3>
      <p>سیب زمینی-سس خردل-پنیرموزارلا-پنیر چدار-پنیر پارمیسان-چیپس  </p>
    <div class="in-text">
      <div class="price">
        <h6>175,000  تومان  </h6>
      </div>
...
<section class="review">
  <div class="middle-text">
    <h4>مشتریان</h4>
    <h2>نظرات شما درمورد غذاهای ما</h2>
  </div>
...
<section class="mid-text">
  <div class="midlee-text">
        <h4> تماس با ما</h4>
       <h2>راه های ارتباطی ما </h2>
  </div>
</section>
...
<section class="container">
  ...
  <div class="container-box">
  <img src="img/c2.png">
  <h3>فارس-شیراز-لورم ایپسوم متن ساختگی با تولید سادگی </h3>
  <a href="#">آدرس</a>
  </div>
