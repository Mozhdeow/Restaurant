...
let prevMenu = document.getElementById('prev-menu');
let nextMenu = document.getElementById('next-menu');
...
function runCarousel() {
    prevMenu.style.display = (active == 0) ? 'none' : 'block';
    nextMenu.style.display = (active == count - 1) ? 'none' : 'block';
...
document.querySelectorAll('.content-tab .slide').forEach(food =>{
    food.onclick = () => {
